...
public abstract class Seed {
	...
	public static List<Address> createAdresses() {
		...
		address1.setLocation("Lajeado");
		address1.setUf("RS");
		address1.setAddress("R. Santos Filho, 394");

		Address address2 = new Address();
		address2.setCep(1220010);
		address2.setDistrict("República");
		address2.setLocation("São Paulo");
		address2.setUf("SP");
		address2.setAddress("R. Rêgo Freitas, 133");

		Address address3 = new Address();
		address3.setCep(90040191);
		address3.setDistrict("Cidade Baixa");
		address3.setLocation("Porto Alegre");
		address3.setUf("RS");
		address3.setAddress("Av. Venâncio Aires, 243");
